...
public class MiracleIndexDailyPrice  implements java.io.Serializable {
    ...
    public MiracleIndexDailyPrice(int id, String ticker, Date date, BigDecimal open, BigDecimal close, BigDecimal high, BigDecimal low, BigDecimal range, int volume, int avg5Volume, int avg10Volume, int avg20Volume, int avg30Volume, int avg60Volume, BigDecimal ma5, BigDecimal ma10, BigDecimal ma20, BigDecimal ma30, BigDecimal ma60) {
       this.id = id;
       this.ticker = ticker;
       this.date = date;
       this.open = open;
